...
""" Plot the centre of mass trajectories of filaments per simulation"""

### example command line arguments: 
###    -fl=/local/duman/SIMULATIONS/Motor/.../ 
###         -sb=/usr/users/iff_th2/duman/Motor/PLOTS/
###             -sf=TRAJECTORY
###             -ti=10 -tf=2000
...
def main():
    ...
    plot_traj(fils.xu, sim, args.init_time, args.fin_time, \
